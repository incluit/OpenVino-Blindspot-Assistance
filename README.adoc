...
Status]]
![Docker Build Status](https://img.shields.io/docker/build/openvinoincluit/blindspot-openvino?style=plastic)


https://img.shields.io/docker/build/openvinoincluit/blindspot-openvino?style=plastic
